...
__export(query_interface_internal_exports, {
  IBMiQueryInterfaceInternal: () => IBMiQueryInterfaceInternal
});
...
class IBMiQueryInterfaceInternal extends import_query_interface_internal.AbstractQueryInterfaceInternal {
  constructor(dialect) {
    super(dialect);
