...
const SHOW_CONSTRAINTS_QUERY_SUPPORTED_OPTIONS = /* @__PURE__ */ new Set([
  "constraintName",
  "constraintType"
]);
class SnowflakeQueryGeneratorTypeScript extends import_query_generator.AbstractQueryGenerator {
  ...
  createDatabaseQuery(database, options) {
    ...
    return (0, import_join_sql_fragments.joinSQLFragments)([`CREATE DATABASE IF NOT EXISTS ${this.quoteIdentifier(database)}`]);
  }
