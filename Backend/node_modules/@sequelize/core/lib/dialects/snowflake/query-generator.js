...
class SnowflakeQueryGenerator extends SnowflakeQueryGeneratorTypeScript {
  ...
  quoteIdentifier(identifier, force) {
    ...
    if (optForceQuote === true || // TODO [>7]: drop this.options.quoteIdentifiers. Always quote identifiers.
    optQuoteIdentifiers !== false || identifier.includes(".") || identifier.includes("->") || SNOWFLAKE_RESERVED_WORDS.includes(identifier.toLowerCase())) {
