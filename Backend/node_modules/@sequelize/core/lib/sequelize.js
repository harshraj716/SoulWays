...
var import_associations = require("./associations/index");
var DataTypes = __toESM(require("./data-types"));
var import_deferrable = require("./deferrable");
var import_query_interface = require("./dialects/abstract/query-interface");
...
class Sequelize extends import_sequelize_typescript.SequelizeTypeScript {
  ...
  constructor(database, username, password, options) {
    ...
    this.options.replication.write = (0, import_defaults.default)(
...
Sequelize.prototype.Association = Sequelize.Association = import_associations.Association;
